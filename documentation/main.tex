...
the internal \texttt{networkx} functions were used, such as \texttt{minimum_spanning_tree}, 
\texttt{eulerian_circuit} and \texttt{min_weight_matching}.

For keeping track of time and allocated memory, the libraries \texttt{time} and 
\texttt{memory_profiler} were chosen, as they provided the most convenient interface.
