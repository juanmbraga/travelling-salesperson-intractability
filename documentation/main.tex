...
from \textbf{picturing the problem as a tree}, especially in the Section~\ref{sec:algorithms}.
...
(using a small dataset to fit the execution of the Christofides algorithm).

The student was not able to implement a useful branch-and-bound solution to compare with the approximations. 
